...
begin
  ...
  -- Estes dois campos são normalizados em gramas, mesmo quando o preço de referência é por kg.
...
-- O navegador não precisa consultar preço por ID de produto diretamente.
-- O fechamento do pedido chama esta função internamente no servidor.
