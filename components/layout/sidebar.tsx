...
import { LayoutDashboard, ShoppingBag, Utensils, Settings, Bike, ChefHat, Banknote, BarChart3, PackageOpen, Users, Tags, Armchair, Boxes, UserCog, BadgeDollarSign, LockKeyhole, Megaphone, LogOut, MessageSquareText, SlidersHorizontal } from "lucide-react";
...
const items: Array<{href:string;label:string;icon:typeof LayoutDashboard;module:ModuleKey}> = [
  ...
  { href: "/estoque-simples", label: "Estoque simples", icon: PackageOpen, module: "stock_basic" },
  { href: "/estoque", label: "Estoque avançado", icon: PackageOpen, module: "stock_advanced" },
