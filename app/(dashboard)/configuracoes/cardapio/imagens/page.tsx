...
export default async function MenuImagesPage() {
  ...
  return <main className="space-y-8 pb-16">
    <header>
      <Link href="/configuracoes/cardapio" className="mb-4 inline-flex items-center gap-2 text-sm font-semibold text-emerald-700"><ArrowLeft size={16}/> Voltar para o cardápio</Link>
      <p className="text-sm font-semibold text-emerald-700">Configurações › Cardápio</p>
      <h1 className="text-3xl font-bold">Imagens do cardápio</h1>
      <p className="mt-2 max-w-3xl text-gray-600">Gerencie a logomarca e o banner da {company.name}. As fotos de produtos, combos e complementos continuam dentro do cadastro de cada item.</p>
    </header>

    {canManageBrand ? <section>
      <h2 className="mb-4 text-xl font-bold">Identidade visual da loja</h2>
    ...
    </section> : <p className="rounded-2xl border bg-white p-6 text-gray-600">Somente proprietários e gerentes podem alterar a identidade visual da loja.</p>}
  </main>;
}
